...
export const AuthProvider = ({ children }) => {
  ...
  useEffect(() => {
    const unsubscribe = auth.onAuthStateChanged((user) => {
      if (user) {
        ...
        if (user.email === 'samriddhabasu1234@gmail.com' || user.email === 'mytravelsguru@gmail.com'  || user.email === 'mytravelsguru2024@gmail.com'  || user.email === 'jeetrock007@gmail.com') {
  ...
  const handleLogin = async () => {
    try {
      ...
      if (result.user.email === 'samriddhabasu1234@gmail.com' || user.email === 'mytravelsguru@gmail.com'  || user.email === 'mytravelsguru2024@gmail.com'  || user.email === 'jeetrock007@gmail.com') {
